...
#include "WolfJaw/TP_WeaponComponent.h"
...
WOLFJAW_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
WOLFJAW_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
{
	...
	{
		AWolfJawCharacter* TargetCharacter;
		bool ReturnValue;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(AWolfJawCharacter,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2628865751
...
template<> WOLFJAW_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_chris_OneDrive_Documents_Unreal_Projects_WolfJaw_Source_WolfJaw_TP_WeaponComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 3525100722U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_chris_OneDrive_Documents_Unreal_Projects_WolfJaw_Source_WolfJaw_TP_WeaponComponent_h_1830329670(TEXT("/Script/WolfJaw"),
	Z_CompiledInDeferFile_FID_Users_chris_OneDrive_Documents_Unreal_Projects_WolfJaw_Source_WolfJaw_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_chris_OneDrive_Documents_Unreal_Projects_WolfJaw_Source_WolfJaw_TP_WeaponComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
